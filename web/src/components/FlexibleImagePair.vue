<template>
  <div :class="'flexible-image-pair grid grid--12-desktop container mb-90 ai-c large-location--' + content.imageLargeLocation + ' reverse-mobile--' + content.reverseMobile">
